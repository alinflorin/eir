...
/**
 * Connects to rabbitmq using the "template-microservice" access token as the SASL PLAIN
 ...
 *   publish(payload, { service: 'template-microservice' }) -> services.template-microservice.ClassName
 ...
 * template-microservice that reacts to requests from any user, rather than one scoped
